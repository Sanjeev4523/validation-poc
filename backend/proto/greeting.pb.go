...
const file_proto_greeting_proto_rawDesc = "" +
	"\n" +
	"\x14proto/greeting.proto\x12\x05proto\x1a\x1bbuf/validate/validate.proto\"+\n" +
	"\fHelloRequest\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x03R\x04name\")\n" +
	"\rHelloResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2H\n" +
	"\x0fGreetingService\x125\n" +
	"\bSayHello\x12\x13.proto.HelloRequest\x1a\x14.proto.HelloResponseB\"Z validation-service/backend/protob\x06proto3"
...
var file_proto_greeting_proto_depIdxs = []int32{
	0, // 0: proto.GreetingService.SayHello:input_type -> proto.HelloRequest
	1, // 1: proto.GreetingService.SayHello:output_type -> proto.HelloResponse
